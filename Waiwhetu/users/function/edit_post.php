...
<form  action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="" name="category" required>
    </div>
    <div class="form-group">
...
if(isset($_POST['submit'])){
    ...
    $insert_post .= "VALUES('{$user_id}','{$post_title}', '{$post_p_text}', '{$post_image}','{$post_date}',  '{$post_author}','{$author_name}','pendding')";
    ...
    $('#post_modal').modal('show');
        ...
        $insert_post = "INSERT INTO posts(user_id,post_title, post_content, image, post_date, author,author_name)";
    $insert_post .= "VALUES('{$user_id}','{$post_title}', '{$post_p_text}', '{$post_image}','{$post_date}',  '{$post_author}','{$author_name}')";
