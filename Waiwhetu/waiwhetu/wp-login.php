...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	if ( is_multisite() ) {
		...
		$login_header_url   = __('waiwhetu.devlab.ac.nz');
		$login_header_title = __('Waiwhetu Marae');
	}
...
function login_footer($input_id = '') {
	...
	if ( ! $interim_login ): ?>
	<p id="backtoblog"><a href="<?php echo esc_url('waiwhetu.devlab.ac.nz'); ?>"><?php printf( __( '&larr; Back to %s' ), get_bloginfo( 'title', 'display' ) ); ?></a></p>
	<?php endif; ?>
